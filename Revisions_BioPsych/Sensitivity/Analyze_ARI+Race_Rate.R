...
inputPath<-'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/longitudinal/n137_Nmf24BasesCT_COMBAT_Rate.csv'
...
covsFormula <- "~s(TP1_ageAtScan1,k=4)+TP2_sex+DeltaQA+TP2_ari_log+TP1_race"
