...
covsFormula="~s(TP1ageAtScan1,k=4)+ari_log+sex+DeltaManualRating"
...
Rscript /data/jux/BBL/projects/jirsaraieStructuralIrrit/scripts/jirsaraieStructuralIrritability/APR_Analysis/gamROI.R  -c $subjDataName -o $OutDirRoot -p ${i} -i $inclusionName -u $subjID -f $covsFormula -a $pAdjustMethod -r $residualMap -n 5
