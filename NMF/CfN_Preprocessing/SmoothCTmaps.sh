...
TP1=$(cat /data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/baseline/n140_Nmf24BasesCT_TP1.csv | cut -d ',' -f2 | grep -v "scanid")
TP2=$(cat /data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/follow-up/n141_Nmf24BasesCT_TP2.csv | cut -d ',' -f1 | grep -v "bblid")
