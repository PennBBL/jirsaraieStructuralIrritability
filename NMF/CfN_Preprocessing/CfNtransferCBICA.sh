...
#######################################################################
 ...
 scp rjirsaraie@chead:/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMF_Loadings/n141_T1_train_bblids_scanids.csv $CBICAsubs/
 scp rjirsaraie@chead:/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/NMF_Loadings/n140_T1_test_bblids_scanids.csv $CBICAsubs/
