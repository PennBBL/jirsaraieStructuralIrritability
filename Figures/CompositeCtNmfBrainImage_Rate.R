...
data.NMF <- readRDS("/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/longitudinal/n137_Nmf24BasesCT_COMBAT_Rate.csv")
...
output<-read.csv("/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/FINAL/longitudinal/n137_rds_n137_Demo+Psych+DX+QA_20180531_inclusion_DeltaT1Exclude_ROI_n137_Nmf24BasesCT_COMBAT_Rate/gam_formula_sTP1_ageAtScan1k4_TP2_sex_DeltaQA_TP2_ari_log_coefficients.csv")
...
antsImageWrite(tvalMap,"/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/NMF_Figures/F4_Rate/n137_CtNmfSigComponents_COMBAT_t300_Rate.nii.gz")
