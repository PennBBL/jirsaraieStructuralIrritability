...
summary(NC$TP1_IrritabilitySum)
sd(NC$TP1_IrritabilitySum, na.rm=TRUE)
summary(DX$TP1_IrritabilitySum)
sd(DX$TP1_IrritabilitySum, na.rm=TRUE)
summary(Resilient$TP1_IrritabilitySum)
sd(Resilient$TP1_IrritabilitySum, na.rm=TRUE)
