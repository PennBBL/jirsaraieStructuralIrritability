...
inputPath <- '/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/baseline/n140_Nmf24BasesCT_COMBAT_TP1.csv'
...
covsFormula <- "~s(ageAtScan1,k=4)+sex+averageManualRating+ari_log_FOLLOWUP"
...
if (is.null(m[[1]]$s.table)) {
  ...
  output<-output[order(output$tval.ari_log_FOLLOWUP),]
