...
subjDataName<-'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/longitudinal/n137_Demo+Psych+DX+QA+FD_20190704.rds'
OutDirRoot <- '/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/FINAL/Revisions_NPP/Sensitivity'
covsFormula <- "~s(TP2_ScanAgeYears,k=4)+TP2_sex+TP2_rating+TP2_ari_log+grmpy_fd"
