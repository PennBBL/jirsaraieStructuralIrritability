...
inputPath<-'/data/jux/BBL/projects/jirsaraieStructuralIrrit/data/processedData/follow-up/n141_Nmf11SIGBasesCT_COMBAT_TP2.csv'
...
OutDirRoot <- '/data/jux/BBL/projects/jirsaraieStructuralIrrit/output/FINAL/Revisions_NPP/Sensitivity'
