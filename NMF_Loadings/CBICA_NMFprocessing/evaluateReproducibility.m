...
set(gca,'fontsize',12)
saveas(fig,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/MeanInnerProduct_CT.pdf');
...
set(gca,'fontsize',12)
saveas(fig2,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/MedianInnerProduct_CT.pdf');

fig3 = figure;plot(sortedBasisNum,ARI,'b','LineWidth',2)
xlabel('Number of components','fontsize',12)
ylabel({'Split-sample reproducibility' ;'(Adjusted Rand Index)'},'fontsize',12)
set(gca,'fontsize',12)
saveas(fig3,'/cbica/projects/pncNmf/grmpyNMF/n281_Final_201804/output/graphs/splithalf/AdjustedRandIndex_CT.pdf');
